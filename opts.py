...
def parse_opts():
    ...
    parser.add_argument(
        '--root_path',
        default='/nfs_mount/datasets/UCF101',
        type=str,
        help='Root directory path of data')
    parser.add_argument(
        '--video_path',
        default='/nfs_mount/datasets/UCF101/UCF-101/videos',
        type=str,
        help='Directory path of Videos')
    parser.add_argument(
        '--annotation_path',
        default='/nfs_mount/code/ananth/code/Verisk/3D-ResNets-PyTorch/datasets/ucf101_01.json',
        type=str,
