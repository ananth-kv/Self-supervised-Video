...
if __name__ == '__main__':
    ...
    csv_dir_path = "/nfs_mount/datasets/UCF101/ucfTrainTestlist/"
    ...
    for split_index in range(1, 4):
        ...
        dst_json_path = os.path.join("/nfs_mount/code/ananth/code/Verisk/3D-ResNets-PyTorch/datasets", 'ucf101_0{}.json'.format(split_index))
